<template>
  <div class="container">
    ...
    <p>Welcome to Popcorns!</p>

    <p>
      These terms and conditions outline the rules and regulations for the use
      of Popcorns's website and services, located at https://popcorns.io and its
      subdomains.
    </p>

    <p>
      By accessing this website we assume you accept these terms and conditions.
      Do not continue to use Popcorns if you do not agree to take all of the
    ...
    <p>
      We employ the use of cookies. By accessing Popcorns, you agreed to use
      cookies in agreement with the Popcorns's
      <a href="/privacy-policy">Privacy Policy</a>.
    </p>

    <p>
      Most interactive websites use cookies to retrieve the user’s details for
    ...
    <p>
      Unless otherwise stated, Popcorns and/or its licensors own the
      intellectual property rights for all material on Popcorns. All
      intellectual property rights are reserved. You may access this from
      Popcorns for your own personal use subjected to restrictions set in these
      terms and conditions.
    </p>

    <p>You must not:</p>

    <p>- Sell, rent or sub-license material from Popcorns</p>
    <p>- Reproduce, duplicate or copy material from Popcorns</p>

    <p>
      Parts of this website offer an opportunity for users to post and exchange
      opinions and information in certain areas of the website. Popcorns does
      not filter, edit, publish or review Comments prior to their presence on
      the website. Comments do not reflect the views and opinions of Popcorns,
      ...
      applicable laws, Popcorns shall not be liable for the Comments or for any
    ...
    <p>
      Popcorns reserves the right to monitor all Comments and to remove any
    ...
    <p>
      You hereby grant Popcorns a non-exclusive license to use, reproduce, edit
    ...
    <p>
      No use of Popcorns's logo or other artwork will be allowed for linking
